% =====================================================================
%  CV general en INGLÉS. Cuerpo; el preámbulo está en cv-preamble.tex.
%
...
%
%  Su gemelo en español es cv-body-es.tex. Al cambiar contenido aquí, hay
%  que cambiarlo allí: no se traducen solos.
% =====================================================================
...
\begin{center}
  ...
  {\footnotesize
   ...
   \ {\color{subtle}$\vert$} \
   \href{https://johanrodriguez.is-a.dev/en}{johanrodriguez.is-a.dev}}
\end{center}
\vspace{0.2ex}
...
\href{https://johanrodriguez.is-a.dev/en/projects}{johanrodriguez.is-a.dev/projects}.\par}
\else
